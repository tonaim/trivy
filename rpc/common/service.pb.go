...
var file_rpc_common_service_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0xcf, 0x09, 0x0a, 0x0d, 0x56,
	...
	0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x44, 0x61, 0x74, 0x65, 0x12, 0x30, 0x0a, 0x14, 0x63, 0x75,
	0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x61, 0x64, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x79, 0x5f, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x12, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	0x41, 0x64, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x79, 0x44, 0x61, 0x74, 0x61, 0x12, 0x28, 0x0a, 0x10,
	0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x76, 0x75, 0x6c, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x12, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x75,
...
var file_rpc_common_service_proto_depIdxs = []int32{
	...
	29, // 16: trivy.common.Vulnerability.cvss:type_name -> trivy.common.Vulnerability.CvssEntry
	31, // 17: trivy.common.Vulnerability.published_date:type_name -> google.protobuf.Timestamp
	31, // 18: trivy.common.Vulnerability.last_modified_date:type_name -> google.protobuf.Timestamp
	15, // 19: trivy.common.Vulnerability.data_source:type_name -> trivy.common.DataSource
	30, // 20: trivy.common.Vulnerability.vendor_severity:type_name -> trivy.common.Vulnerability.VendorSeverityEntry
	21, // 21: trivy.common.CauseMetadata.code:type_name -> trivy.common.Code
	16, // 22: trivy.common.CustomResource.layer:type_name -> trivy.common.Layer
	32, // 23: trivy.common.CustomResource.data:type_name -> google.protobuf.Value
	20, // 24: trivy.common.Code.lines:type_name -> trivy.common.Line
	21, // 25: trivy.common.SecretFinding.code:type_name -> trivy.common.Code
	16, // 26: trivy.common.SecretFinding.layer:type_name -> trivy.common.Layer
	22, // 27: trivy.common.Secret.findings:type_name -> trivy.common.SecretFinding
	...
	26, // 31: trivy.common.LicenseFile.fingings:type_name -> trivy.common.LicenseFinding
	16, // 32: trivy.common.LicenseFile.layer:type_name -> trivy.common.Layer
	1,  // 33: trivy.common.LicenseFinding.category:type_name -> trivy.common.LicenseCategory.Enum
	18, // 34: trivy.common.Vulnerability.CvssEntry.value:type_name -> trivy.common.CVSS
